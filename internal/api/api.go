...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /v1/reconcile", s.scanDrift)
	...
	mux.HandleFunc("GET /v1/invoices/{invoice_id}/revenue", s.revenueRecognition)
	...
	mux.HandleFunc("GET /v1/dunning/templates", s.listDunningTemplates)
	mux.HandleFunc("PUT /v1/dunning/templates/{event}", s.setDunningTemplate)
